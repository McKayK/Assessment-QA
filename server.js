...
var rollbar = new Rollbar({
  accessToken: "95cba7c50a6b4afb85cde780f37d9346",
...
app.get("/api/robots", (req, res) => {
  ...
  rollbar.critical("Robots failed to load");
});
...
app.post("/api/duel", (req, res) => {
  ...
  rollbar.log("sorry, the bot always wins");
});
...
app.get("/api/player", (req, res) => {
  ...
  rollbar.warning("win count broken");
});
